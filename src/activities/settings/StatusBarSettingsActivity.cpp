...
const uint8_t pageCountRawValues[PAGE_COUNT_ITEMS] = {
    CrossPointSettings::STATUS_BAR_PAGE_COUNT::PAGE_COUNT_HIDE,
    CrossPointSettings::STATUS_BAR_PAGE_COUNT::PAGE_COUNT_CHAPTER,
    CrossPointSettings::STATUS_BAR_PAGE_COUNT::PAGE_COUNT_BOOK,
};
...
StrId optionNameForItem(const int item, const int optionIndex) {
  switch (item) {
    case ITEM_PAGE_COUNT:
      return pageCountNames[optionIndex];
    case ITEM_PROGRESS_BAR:
