...
class HomeActivity final : public Activity {
 ...
 private:
  ...
  CarouselCoverTouch carouselCoverTouch;
  ...
  // Leaving a grayscale reader needs one absolute HALF clean to erase physical
  // AA residue. Subsequent Home interaction remains on the FAST path.
  bool initialCleanRefresh = false;
 ...
 public:
  explicit HomeActivity(GfxRenderer& renderer, MappedInputManager& mappedInput,
                        ...
                        bool initialCleanRefreshValue = false)
      : Activity("Home", renderer, mappedInput),
        initialFullRefresh(initialFullRefreshValue),
        initialCleanRefresh(initialCleanRefreshValue),
